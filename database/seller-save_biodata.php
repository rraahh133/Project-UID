...
$stmt = $pdo->prepare("SELECT * FROM seller_information WHERE user_id = :user_id");
...
if ($user_info) {
    ...
    $query = "UPDATE seller_information SET name = :name, birthdate = :birthdate, gender = :gender, email = :email, phone = :phone";
    if ($profile_picture) {
    ...
    $query = "INSERT INTO seller_information (user_id, name, birthdate, gender, email, phone";
    if ($profile_picture) {
