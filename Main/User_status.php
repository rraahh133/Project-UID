        ...
        <div class="flex flex-1">
            ...
            <main class="flex-1 p-6">
                ...
                <div class="bg-white p-6 rounded shadow">
                    <h2 class="text-2xl font-bold mb-4">Status Pembayaran</h2>
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white">
                            <thead>
                                <tr>
                                    <th class="py-2 px-4 border-b">No</th>
                                    <th class="py-2 px-4 border-b">Nomor Transaksi</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b">TRX123456</td>
                                    <td class="py-2 px-4 border-b">01 Desember 2024</td>
                                    <td class="py-2 px-4 border-b"><span class="text-green-500 font-bold">Lunas</span>
                                    </td>
                                    <td class="py-2 px-4 border-b"><a href="#" class="text-blue-500">Lihat</a></td>
                                </tr>
                                <tr>
                                    <td class="py-2 px-4 border-b">2</td>
                                    <td class="py-2 px-4 border-b">TRX654321</td>
                                    <td class="py-2 px-4 border-b">29 November 2024</td>
                                    <td class="py-2 px-4 border-b"><span class="text-red-500 font-bold">Belum
                                            Lunas</span></td>
                                    <td class="py-2 px-4 border-b"><a href="#" class="text-blue-500">Lihat</a></td>
                                </tr>
                            </tbody>
